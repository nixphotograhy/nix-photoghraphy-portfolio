      ...
      <div className="max-w-7xl mx-auto flex flex-col relative">
        ...
        {displayImages[0] && (
          <motion.div 
            style={{ y: y1 }}
            viewport={{ once: true }}
            className="relative z-10 w-[55%] md:w-[35%] self-start flex flex-col gap-4 md:gap-12 mt-12 md:mt-0"
          >
        ...
        {displayImages[1] && (
          <motion.div 
            style={{ y: y2 }}
            viewport={{ once: true }}
            className="relative z-20 w-[55%] md:w-[35%] self-center -mt-8 md:-mt-32 lg:-mt-48 flex flex-col gap-4 md:gap-12"
          >
        ...
        {displayImages[2] && (
          <motion.div 
            style={{ y: y3 }}
            viewport={{ once: true }}
            className="relative z-10 w-[55%] md:w-[35%] self-end -mt-8 md:-mt-32 lg:-mt-48 flex flex-col gap-4 md:gap-12"
          >
            <div className="relative aspect-[4/5] overflow-hidden border border-white/5 shadow-2xl group">
               {/* Corner Architectural Marks */}
               <div className="absolute top-4 left-4 w-2 h-2 border-t border-l border-white/40 z-10 opacity-0 group-hover:opacity-100 transition-opacity" />
